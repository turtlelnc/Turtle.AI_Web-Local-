...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SessionSelectPromptProfileRequest: 'session.md',
  SessionSelectPromptProfileValue: 'session.md',
  PromptProfileCatalogValue: 'session.md',
  PromptProfileCreateRequest: 'session.md',
  PromptProfileUpdateRequest: 'session.md',
  PromptProfileRemoveRequest: 'session.md',
  PromptProfileWriteValue: 'session.md',
  PromptProfileRemoveValue: 'session.md',
  ...
  ConfigureTeamProjectRequest: 'agent-team.md',
  ...
  TeamProjectMutationResult: 'agent-team.md',
  ...
  AuthorizationListValue: 'credentials.md',
  AuthorizationBeginRequest: 'credentials.md',
  AuthorizationBeginValue: 'credentials.md',
  AuthorizationRespondRequest: 'credentials.md',
  AuthorizationCancelRequest: 'credentials.md',
  AuthorizationLogoutRequest: 'credentials.md',
  AuthorizationActionValue: 'credentials.md',
  AuthorizationWatchRequest: 'credentials.md',
  AuthorizationWatchFrame: 'credentials.md',
  ...
  PromptProfileDefinition: 'core.md',
  PromptProfileDraft: 'core.md',
  PromptProfileDefaultRule: 'core.md',
  PromptProfileId: 'core.md',
  PromptProfileSelection: 'core.md',
