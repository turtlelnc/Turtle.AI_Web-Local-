...
export const en = {
  ...
  'chatgpt.title': 'ChatGPT / Codex',
  'chatgpt.description': 'Sign in with ChatGPT to use Codex models. Access tokens remain in the Host credential boundary.',
  'chatgpt.compatBackend': 'Compatible OAuth fallback',
  'chatgpt.connected': 'Connected',
  'chatgpt.disconnected': 'Not connected',
  'chatgpt.openLogin': 'Open login page',
  'chatgpt.cancel': 'Cancel login',
  'chatgpt.logout': 'Sign out',
  'chatgpt.respond': 'Continue',
  'profiles.nav': 'Prompt Profiles',
  'profiles.title': 'Prompt Profiles',
  'profiles.intro': 'Choose agent behavior independently from the model provider. Custom profiles extend a built-in profile without replacing tools or safety rules.',
  'profiles.mapping': 'Auto uses Codex for ChatGPT and OpenAI, and DeepSeek Harness for DeepSeek and compatible providers.',
  'profiles.create': 'Create custom profile',
  'profiles.name': 'Name',
  'profiles.base': 'Built-in base',
  'profiles.base.codex': 'Codex',
  'profiles.base.deepseekHarness': 'DeepSeek Harness',
  'profiles.instructions': 'Additional instructions',
  'profiles.revisionPrefix': 'r',
  edit: 'Edit',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  'chatgpt.title': 'ChatGPT / Codex',
  'chatgpt.description': '登录 ChatGPT 后使用 Codex 模型。访问令牌始终留在 Host 凭据边界内。',
  'chatgpt.compatBackend': '兼容 OAuth 回退',
  'chatgpt.connected': '已连接',
  'chatgpt.disconnected': '未连接',
  'chatgpt.openLogin': '打开登录页面',
  'chatgpt.cancel': '取消登录',
  'chatgpt.logout': '退出登录',
  'chatgpt.respond': '继续',
  'profiles.nav': '提示词配置',
  'profiles.title': '提示词配置',
  'profiles.intro': '将 Agent 行为与模型提供方独立选择。自定义配置只能扩展内置配置，不会替换工具或安全规则。',
  'profiles.mapping': '自动模式为 ChatGPT 和 OpenAI 使用 Codex，为 DeepSeek 与兼容提供方使用 DeepSeek Harness。',
  'profiles.create': '创建自定义配置',
  'profiles.name': '名称',
  'profiles.base': '内置基础',
  'profiles.base.codex': 'Codex',
  'profiles.base.deepseekHarness': 'DeepSeek Harness',
  'profiles.instructions': '附加指令',
  'profiles.revisionPrefix': 'r',
  edit: '编辑',
